...
import (
    ...
    vegeta "github.com/xinst/vegeta/lib"
)
...
func attackCmd() command {
    ...
    fs.DurationVar(&opts.tlstimeout, "tlstimeout", vegeta.DefaultTLSTimeout, "TLS handshake timeout")
...
func attack(opts *attackOpts) (err error) {
    ...
    atk := vegeta.NewAttacker(
        ...
        vegeta.TLSTimeout(opts.tlstimeout),
